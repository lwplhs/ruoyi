...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', 'admin', '00', '', '', '1', '', '$2a$10$PGtHAc49ak9CtLdPC2GnpOHfcvepDnFoQPj3.Ulx2aNClwFkVdi8O', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '管理员');
insert into sys_user values(2,  105, 'ry',    'ry', '00', '',  '', '1', '', '$2a$10$PGtHAc49ak9CtLdPC2GnpOHfcvepDnFoQPj3.Ulx2aNClwFkVdi8O', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '测试员');
